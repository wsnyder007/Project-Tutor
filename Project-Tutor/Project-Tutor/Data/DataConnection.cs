...
namespace Project_Tutor.Data {
    class DataConnection {
        ...
        public static List<Course> GetUserCourses(int userId) {
            ...
            courses.Add(new Course(1, "CSC 100", new List<int>() { 1 }));
            courses.Add(new Course(2, "CSC 101", new List<int>() { 1 }));
            courses.Add(new Course(3, "CSC 220", new List<int>() { 1 }));
            courses.Add(new Course(4, "CSC 402", new List<int>() { 1 }));
            return courses;
        }
    }
}
